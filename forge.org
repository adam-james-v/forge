...
{:deps 
 {org.clojure/clojure            {:mvn/version "1.10.2"}
  ...
  svg-clj/svg-clj                {:local/root  "/Users/adam/dev/svg-clj"} #_{:mvn/version "0.5.3"}
...
(defmethod write-expr :rect [depth [form {:keys [x y center]}]]
...
(defmethod write-expr :project [depth [form {:keys [cut]} & block]]
  (concat
...
(defmethod write-expr :box [depth [form {:keys [x y z center]}]]
...
(defmethod write-expr :extrude [depth [form {:keys [height twist convexity center slices scale]} & block]]
  (concat
...
(defmethod write-expr :revolve [depth [form {:keys [convexity fn angle]} & block]]
  (concat
